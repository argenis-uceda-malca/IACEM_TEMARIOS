...
use Controllers\TemasController;
use Controllers\CicloController;
...
$router->get('/', [AdministradorController::class, 'login']);
$router->get('/viewcurso', [CursoController::class, 'viewcurso']);
$router->get('/admincurso', [CursoController::class, 'admincurso']);
$router->get('/viewciclo', [CicloController::class, 'viewciclo']);
$router->post('/addEditarTema', [TemasController::class, 'addEditarTema']);
$router->post('/addEditarCiclo', [CicloController::class, 'addEditarCiclo']);
$router->post('/eliminarciclo', [CicloController::class, 'eliminarciclo']);
$router->post('/eliminarcurso', [CursoController::class, 'eliminarcurso']);
$router->post('/eliminartema', [TemasController::class, 'eliminartema']);
