            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    ...
                    <a href="/admin">
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="/build/img/IACEM_LOGO.png" alt="homepage" class="dark-logo" style="width:170px ;" />
                            <!-- Light Logo icon -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                ...
                <ul class="navbar-nav float-right ">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="/build/admin/assets/images/users/icons8-male-user-100.png" alt="user" class="rounded-circle" width="40">
